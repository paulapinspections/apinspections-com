  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="flex items-start">
                <ClipboardCheck className="h-6 w-6 text-blue-600 mr-3 flex-shrink-0 mt-0.5" />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-900">Our Process</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 text-white font-bold text-2xl mb-4">
                1
              </div>
              <h3 className="text-lg font-semibold mb-2 text-blue-900">Schedule</h3>
              <p className="text-blue-700">Call or book online to schedule your inspection</p>
            </div>
            <div className="text-center">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 text-white font-bold text-2xl mb-4">
                2
              </div>
              <h3 className="text-lg font-semibold mb-2 text-blue-900">Inspect</h3>
              <p className="text-blue-700">We thoroughly inspect the property (2-4 hours)</p>
            </div>
            <div className="text-center">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 text-white font-bold text-2xl mb-4">
                3
              </div>
              <h3 className="text-lg font-semibold mb-2 text-blue-900">Report</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-blue-900">Support</h3>
              <p className="text-blue-700">We're available to answer questions about your report</p>
            </div>
          </div>
        </div>
      </section>
